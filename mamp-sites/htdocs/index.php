...
<html lang="<?php echo $language; ?>">
  ...
  <body>
    ...
    <?php elseif ($language == 'en'): ?>
      ...
      <p class="text">
      <a href="treehouse/fetch_api/2-writebasic/start/index.html" target="_blank">2-writebasic</a>
    </p>
    <p class="text">
      <a href="treehouse/fetch_api/3-displaycontent/start/index.html" target="_blank">3-displaycontent</a>
    </p> <p class="text">
      <a href="treehouse/fetch_api/4-createreusablefetchfunction/start/index.html" target="_blank">4-createreusablefetchfunction</a>
    </p> <p class="text">
      <a href="treehouse/fetch_api/5-handleerrors/start/index.html" target="_blank">5-handleerrors</a>
    </p> <p class="text">
      <a href="treehouse/fetch_api/6-multiplerequestpromiseall/start/index.html" target="_blank">6-multiplerequestpromiseall</a>
    </p> <p class="text">
      <a href="treehouse/fetch_api/7-postdatafetch/start/index.html" target="_blank">7-postdatafetch</a>
    </p>
